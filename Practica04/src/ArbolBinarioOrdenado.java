...
/**
 * <p>Clase para árboles binarios ordenados.
...
public class ArbolBinarioOrdenado<T extends Comparable<T> > extends ArbolBinario<T> {
     ...
     *        binario ordenado.
     */
    /*public ArbolBinarioOrdenado(Collection<T> coleccion) {
        super(coleccion);
	}*/
    ...
    //////////
    /** public void agrega(T elemento) { //SERIA.....ADD?
     ...
     */
    public void add(T elemento){ // sería..."agrega"?
	if (elemento == null) throw new IllegalArgumentException();
        if (this.isEmpty()) {
            this.raiz = this.ultimoAgregado = nuevoVertice(elemento);
            this.elementos++;
    ...
    //MÉTODOS POR...REVISAR? * son de búsqueda, no de ordenado
    /**
